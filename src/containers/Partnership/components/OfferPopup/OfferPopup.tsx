...
const OFFERS: OffersType = {
  ...
  'Get to know': [
    ...
    },
    {
      ...
      text: 'Під час проведення Хакатону в залах будуть стояти проєктори, на яких Ваша компанія зможе показати свій рекламний ролик або іншу інформацію про себе',
    }
  ]
}
