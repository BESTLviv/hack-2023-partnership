        ...
        <div>
          <div className={styles.feedback_container}>
            <div className={styles.additionalInfo_container}>
              <p>
                Кожен, хто стає партнером у нашому проєкті, має змогу долучитись до благодійного
                збору-розіграшу для ЗСУ в наших соціальних мережах. Серед людей, які задонатять,
                випадковим чином оберуться переможці, які отримають подарунки від
                компаній-партнерів. Також після успішного завершення Хакатону Вам надається фото та
